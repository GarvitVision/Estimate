...
class ZivaWhiteSetup extends StatefulWidget {
  const ZivaWhiteSetup({super.key});

  @override
  State<ZivaWhiteSetup> createState() => _ZivaWhiteSetupState();
}

class _ZivaWhiteSetupState extends State<ZivaWhiteSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("anchorZivaWhite$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    zivaWhiteItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: zivaWhiteItems.length,
                  itemBuilder: (context, index) {
                    String itemName = zivaWhiteItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("anchorZivaWhite$itemName", controller.text);
      },
    );
  }
}
