...
class RomaUrbanSetup extends StatefulWidget {
  const RomaUrbanSetup({super.key});

  @override
  State<RomaUrbanSetup> createState() => _RomaUrbanSetupState();
}

class _RomaUrbanSetupState extends State<RomaUrbanSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("anchorRomaUrban$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    romaUrbanItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: romaUrbanItems.length,
                  itemBuilder: (context, index) {
                    String itemName = romaUrbanItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("anchorRomaUrban$itemName", controller.text);
      },
    );
  }
}
