...
class RomaClassicSetup extends StatefulWidget {
  const RomaClassicSetup({super.key});

  @override
  State<RomaClassicSetup> createState() => _RomaClassicSetupState();
}

class _RomaClassicSetupState extends State<RomaClassicSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("anchorRomaClassic$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    romaClassicItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: romaClassicItems.length,
                  itemBuilder: (context, index) {
                    String itemName = romaClassicItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("anchorRomaClassic$itemName", controller.text);
      },
    );
  }
}
