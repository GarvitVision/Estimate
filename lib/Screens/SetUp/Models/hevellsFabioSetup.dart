...
class HavellsFabioSetup extends StatefulWidget {
  const HavellsFabioSetup({super.key});

  @override
  State<HavellsFabioSetup> createState() => _HavellsFabioSetupState();
}

class _HavellsFabioSetupState extends State<HavellsFabioSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("havellsFabio$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    havellsFabioItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: havellsFabioItems.length,
                  itemBuilder: (context, index) {
                    String itemName = havellsFabioItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("havellsFabio$itemName", controller.text);
      },
    );
  }
}
