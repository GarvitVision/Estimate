...
class ZivaBlackSetup extends StatefulWidget {
  const ZivaBlackSetup({super.key});

  @override
  State<ZivaBlackSetup> createState() => _ZivaBlackSetupState();
}

class _ZivaBlackSetupState extends State<ZivaBlackSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("anchorZivaBlack$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    zivaBlackItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: zivaBlackItems.length,
                  itemBuilder: (context, index) {
                    String itemName = zivaBlackItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("anchorZivaBlack$itemName", controller.text);
      },
    );
  }
}
