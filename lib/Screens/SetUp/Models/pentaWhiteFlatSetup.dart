...
class PentaWhiteFlatSetup extends StatefulWidget {
  const PentaWhiteFlatSetup({super.key});

  @override
  State<PentaWhiteFlatSetup> createState() => _PentaWhiteFlatSetupState();
}

class _PentaWhiteFlatSetupState extends State<PentaWhiteFlatSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("anchorPentaWhiteFlat$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    pentaWhiteFlatItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: pentaWhiteFlatItems.length,
                  itemBuilder: (context, index) {
                    String itemName = pentaWhiteFlatItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("anchorPentaWhiteFlat$itemName", controller.text);
      },
    );
  }
}
