...
class GreatWhiteSetup extends StatefulWidget {
  const GreatWhiteSetup({super.key});

  @override
  State<GreatWhiteSetup> createState() => _GreatWhiteSetupState();
}

class _GreatWhiteSetupState extends State<GreatWhiteSetup> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("greatwhite$itemName");
      if (value != null) {
  ...
  Map<String, TextEditingController> createTextEditingControllers() {
    ...
    greatWhiteItems.forEach((itemName, _) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: greatWhiteItems.length,
                  itemBuilder: (context, index) {
                    String itemName = greatWhiteItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("greatwhite$itemName", controller.text);
      },
    );
  }
}
