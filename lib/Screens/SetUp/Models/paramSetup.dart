...
class _ParamPlaneScreenState extends State<ParamPlaneScreen> {
  ...
  Future getPrefValue() async {
    ...
    controllers.forEach((itemName, controller) {
      String? value = prefs.getString("param$itemName");
      if (value != null) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  itemCount: paramItems.length,
                  itemBuilder: (context, index) {
                    String itemName = paramItems.keys.elementAt(index);
                    return Card(
  ...
  Future<void> storeValuesInSharedPreferences() async {
    ...
    controllers.forEach(
      (itemName, controller) {
        prefs.setString("param$itemName", controller.text);
      },
    );
  }
}
