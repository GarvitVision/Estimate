                            ...
                            builder: (context, snapshot) {
                              if (snapshot.connectionState ==
                                ...
                                return const Center(
                                  ...
                                  ConnectionState.done) {
                                num itemQuantity = num.parse(snapshot.data!);
                          ...
                          FutureBuilder(
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.connectionState ==
                                ...
                                num itemQuantity = num.parse(snapshot.data![1]);
                                itemsAfterLess.add(itemPrice * itemQuantity);
                                return Text(
                                  "${num.parse(controllers[itemName]!.text) * itemQuantity} ₹",
                                  style: TextStyle(
                                    fontSize: screenHeight * 0.02,
                                  ),
                                );
